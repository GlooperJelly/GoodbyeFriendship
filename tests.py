...
class UserModelCase(unittest.TestCase):
    ...
    def test_password_hashing(self):
        u = User(username='Bob')
        u.set_password('aWonderfulPassword')
        self.assertFalse(u.check_password('theWrongPassword'))
        self.assertTrue(u.check_password('aWonderfulPassword'))
    ...
    def test_follow(self):
        ...
        self.assertEqual(u1.followed.first().username, 'alice')
